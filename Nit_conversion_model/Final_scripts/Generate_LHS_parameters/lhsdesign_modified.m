function [p_sets,p_normalized]=lhsdesign_modified(n,min_ranges_p,max_ranges_p)
...
%
%Inputs: 
%       n: number of randomly generated data points
...
%Outputs
%       p_sets: [nxp] matrix of randomly generated variables within the
%       min/max range that the user specified
%       X_normalized: [nxp] matrix of randomly generated variables within the
%       0/1 range 
%
%Example Usage: 
%       [p_sets,p_normalized]=lhsdesign_modified(100,[-50 100 ],[20  300]);
%       figure
...
p_normalized = lhsdesign(n,p);

p_sets=SLOPE.*p_normalized+OFFSET;
