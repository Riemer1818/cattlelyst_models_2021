%% Goal: Function containing the ODEs of model extension 6.1+7
% function containing the ODEs of model extension 6.1+7, the parameters and an IF
% statement to change the formaldehyde concentration at a time point during the
% simulation (not used in this simulation)
%% ODEs of model extension 6.1+7
function dydt = model_e6_2_7(t,y,Fval,t1on,t1off,p)
...
dydt(8) = 3600/(10^-9)*(a4 + a5*(k6^n2)/((k6^n2)+((y(5)*(10^-9))^n2))+a8 + a9*((y(12)*(10^-9))^n4)/((k8^n4)+((y(12)*(10^-9))^n4))-k4*y(6)*(10^-9)*y(8)*(10^-9)+k5*y(7)*(10^-9)-b7*y(8)*(10^-9));
dydt(9) = 3600/(10^-9)*(a2 + a3*(k3^n1)/((k3^n1)+((y(2)*(10^-9))^n1))-b8*y(9)*(10^-9));
%dydt(10)= 3600/(10^-9)*(g3*y(9)*(10^-9)-b9*y(10)*(10^-9));
dydt(10)= 0;
dydt(11)= 3600/(10^-9)*(a4 + a5*(k6^n2)/((k6^n2)+((y(5)*(10^-9))^n2))+a8 + a9*((y(12)*(10^-9))^n4)/((k8^n4)+((y(12)*(10^-9))^n4))-b10*y(11)*(10^-9));
dydt(12)= 3600/(10^-9)*(g4*y(11)*(10^-9)-b11*y(12)*(10^-9));
