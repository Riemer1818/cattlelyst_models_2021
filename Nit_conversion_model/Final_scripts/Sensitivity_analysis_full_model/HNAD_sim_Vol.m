%% Model file for simulation HNAD pseudomonas stutzeri for sensitivity analysis

% Inputs:
% t = time
% y = concentration of species 
% J = Experiment ID, specifies which growth equation should be used to simulate
% Vm = volume medium
% p_sets = parameter guesses for parameters 1-32
...
function [dydt] = HNAD_sim_Vol(t,y,Vm,p,j)
% Input parameters
...
%growth factor (set to 0 if effect of kg is not included in SA)
kg = 0.00; % or 0.003 %min-1
