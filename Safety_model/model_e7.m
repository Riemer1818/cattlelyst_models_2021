%% Goal: Function containing the ODEs of model extension 7
% function containing the ODEs of model extension 7, the parameters and an IF
% statement to change the formaldehyde concentration at a time point during the
% simulation (not used in this simulation)
%% ODEs of model extension 7
function dydt = model_e7(t,y,Fval,t1on,t1off,p)
...
dydt(8) = 3600/(10^-9)*(a4 + a5*(k6^n2)/((k6^n2)+((y(5)*(10^-9))^n2))+a6 + a7*((y(10)*(10^-9))^n3)/((k7^n3)+((y(10)*(10^-9))^n3))-k4*y(6)*(10^-9)*y(8)*(10^-9)+k5*y(7)*(10^-9)-b7*y(8)*(10^-9));
dydt(9) = 3600/(10^-9)*(a4 + a5*(k6^n2)/((k6^n2)+((y(5)*(10^-9))^n2))+a6 + a7*((y(10)*(10^-9))^n3)/((k7^n3)+((y(10)*(10^-9))^n3))-b8*y(9)*(10^-9));
