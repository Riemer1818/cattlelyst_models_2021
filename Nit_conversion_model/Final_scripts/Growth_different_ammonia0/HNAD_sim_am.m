%% Model file for simulation N-dynamics for Pseudomonas spp for different ammonia concentrations
...
function [dydt] = HNAD_sim_am(t,y,Vm,p)
% Input parameters (36)
...
% first if statement changed from 0.2 to 0 since these cells are only exposed to ammonia.
                        % Ammonia growth
                        if y(8) > 0
