%% file used to analyse the output of the simulations of the model extension 1(1) (b10=0)
% contains:
...
% 4. Time series plot e1(1)

% input files: 
%     e1_output_m1_1.mat
%     e1_output_o1_1.mat
%     e1_parameters_o1.mat
%     median_low_hoksokratio2.mat
% output files:
%     e11_max_sensitivity_analysis.mat
%% 1. create a matrix with end concentrations for the parameter sets that have the median p-set of the full model as first 22 parameter values
% load output file median parameter set
load('e1_output_m1_1.mat','sim')
...
save('e11_max_sensitivity_analysis.mat','sort_max')

%% 4. Time series plot e1(1)
load('median_low_hoksokratio2','params_GhighF_ratio');
load('e1_parameters_o1','p_sets')
N = 1;
q = 1;

% select parameter set to simulate 
p_set = 903; %extension 1(1)
p_set_m = 1056; %original biosafety circuit

% make simulation of given paremeter set for extension 1(1) (new) and original
...
sgtitle('Time series extension 1 (b_C_-_F_r_m_R=0) - p-set with highest sensitivity at t=48h','FontSize',22);
