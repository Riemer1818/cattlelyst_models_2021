%% Model file for simulation HNAD pseudomonas stutzeri XL-2 with heaviside

% Inputs:
% t = time
% y = concentration of species 
% j = experiment ID determines which growth function is used
% Vm = volume medium
% p_sets = parameter guesses for parameters 1-36
...
function [dydt] = HNAD_sim_Vol_heaviside(t,y,Vm,p,j)
...
Tmax3a = p(26)*6; % only for the Heaviside function
Tmax3b = p(27);
KT3a = p(28);
KT3b = p(29);
...
%% experiment ID-wise switch of growth
    if j == 1
...
%% Nitrite excretion for XL-2 independent heaviside function
% factor to increase or decrease effect of heaviside function
H1 = 8;

% Threshold value from which heaviside function 1 will work
H2 = 0.1;

% Threshold value from which heaviside function 2 will work *heaviside(y(9)-H3)
H3 = 0.35;
...
%% dNO2-/dt
dydt(5)= ((Tmax3a*y(10)*Vm/KT3a-Tmax3b*y(5)*y(14)/KT3b)/(1+y(10)*Vm/KT3a+y(5)*y(14)/KT3b)-y(5)*y(14)*H1*heaviside(y(5)-H2)*heaviside(y(9)-H3)-(Vmax4a*y(5)*y(14)/Km4a-Vmax4b*y(3)*y(14)/Km4b)/(1+y(5)*y(14)/Km4a+y(3)*y(14)/Km4b)+(Vmax5a*y(4)*y(14)/Km5a-Vmax5b*y(5)*y(14)/Km5b)/(1+y(4)*y(14)/Km5a+y(5)*y(14)/Km5b))/y(14)-mu*y(5);
%N2O/dt
...
%% NO2-ex/dt
dydt(10)= (-(Tmax3a*y(10)*Vm/KT3a-Tmax3b*y(5)*y(14)/KT3b)/(1+y(10)*Vm/KT3a+y(5)*y(14)/KT3b)+y(5)*y(14)*H1*heaviside(y(5)-H2)*heaviside(y(9)-H3))/Vm;
%NOex/dt
