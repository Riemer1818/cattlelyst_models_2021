%% Goal: Function containing the ODEs of model extension 1
% function containing the ODEs of model extension 1, the parameters and an IF
% statement to change the formaldehyde concentration at a time point during the
% simulation (not used in this simulation)
%% ODEs of model extension 1
function dydt = model_e1(t,y,Fval,t1on,t1off,p)
