...
% J = experiment ID, specifies growth function depending on condition
% Vm = volume medium
...
%% Intracellular species
%dNH3/dt 
dydt(1) = ((Tmax1a*y(8)*Vm/KT1a-Tmax1b*y(1)*y(14)/KT1b)/(1+y(8)*Vm/KT1a+y(1)*y(14)/KT1b)-(Vmax1*y(1)*y(14)/(Km1+y(1)*0.6*y(14))))/y(14)-(mu+kg)*y(1);
%dNH2OH/dt
