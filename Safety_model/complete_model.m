%% Goal: Function containing the ODEs of the original model
% function containing the ODEs of the original model, the parameters and an IF
% statement to change the formaldehyde concentration at a time point during the
% simulation (not used in this simulation)
%% ODEs of the full model
function dydt = complete_model(t,y,Fval,t1on,t1off,p)
